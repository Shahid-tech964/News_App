...
class Entertainmenttabbar extends StatefulWidget {
  const Entertainmenttabbar({super.key});

  @override
  State<Entertainmenttabbar> createState() => _EnttertainmenttabbarState();
}

class _EnttertainmenttabbarState extends State<Entertainmenttabbar> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    context.read<Entertainmentbloc>().add(FetchApiNewsEvent());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Entertainmentbloc, NewsState>(
      builder: (_, state) {
        if (state is Success) {
