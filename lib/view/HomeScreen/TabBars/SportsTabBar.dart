...
class _SportstabbarState extends State<Sportstabbar> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<Sportsbloc>().add(FetchApiNewsEvent());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Sportsbloc, NewsState>(
      builder: (_, state) {
        if (state is Success) {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                data[index].title ?? "https://dummyimage.com/300x200/cccccc/000000&text=Image+Not+Available",
                                maxLines: 2,
