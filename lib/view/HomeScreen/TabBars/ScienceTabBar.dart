...
class Sciencetabbar extends StatefulWidget {
  const Sciencetabbar({super.key});

  @override
  State<Sciencetabbar> createState() => _SciencetabbarState();
}

class _SciencetabbarState extends State<Sciencetabbar> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    context.read<Sciencebloc>().add(FetchApiNewsEvent());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Sciencebloc, NewsState>(
      builder: (_, state) {
        if (state is Success) {
