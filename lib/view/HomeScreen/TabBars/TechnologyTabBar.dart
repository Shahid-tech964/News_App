...
class Technologytabbar extends StatefulWidget {
  const Technologytabbar({super.key});

  @override
  State<Technologytabbar> createState() => _TechnologytabbarState();
}

class _TechnologytabbarState extends State<Technologytabbar> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    context.read<Technologybloc>().add(FetchApiNewsEvent());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Technologybloc, NewsState>(
      builder: (_, state) {
        if (state is Success) {
